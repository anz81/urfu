    ...
    return {
        ...
        items: [{
            ...
            items: [{
                xtype: 'label',
                margin: '15 0 0 0',
                text: '3.1. Рекомендуемая литература',
                style: captionStyle
            }, {
                xtype: 'panel',
                height: 600,
                ...
                xtype: 'label',
                text: '3.1.1. Основная литература',
                style: captionStyle
            }, {
                html: '[список с обязательным указанием наименований из ЭБС]',
                style: italicStyle
            }, {
                html: '[заполняется в соответствии с учетом наличия печатных изданий в ЗНБ УрФУ]',
                style: italicStyle
            }, {
                xtype: 'textfield',
                    ...
                    paste: {
                        ...
                        fn: function (event, inputEl) {
                            try {
                                ...
                                console.error('Добавление не выполнено. Не известный формат данных литературы.');
                            }
                ...
                xtype: 'label',
                margin: '15 0 0 0',
                text: '3.1.2. Дополнительная литература',
                style: captionStyle
            }, {
            ...
            items: {
                ...
                items: [{
                    xtype: 'label',
                    text: '3.2. Методические разработки',
                    style: captionStyle
                }, {
                    html: '[список с указанием наименований из ЭБС]',
                    style: italicStyle
            ...
            items: {
                ...
                items: [{
                    xtype: 'label',
                    text: '3.3. Программное обеспечение',
                    style: captionStyle
                }, {
                    html: '[список]',
                    style: italicStyle
                    ...
                    xtype: 'label',
                    text: '3.3.1. Общесистемное и офисное ПО (Microsoft Windows, Microsoft Office, Антивирус Касперского)',
                    ...
                    xtype: 'label',
                    text: '3.3.2 Прикладное ПО, поставленное в комплекте с приборами (программно-аппаратные комплексы)',
                    style: subcaptionStyle
                }, {
                    xtype: 'textareafield',
                    height: 150,
                    ...
                    xtype: 'label',
                    text: '3.3.3 Свободно распространяемое и бесплатное ПО',
                    style: subcaptionStyle
                }, {
                    xtype: 'textareafield',
                    height: 150,
                    ...
                    xtype: 'label',
                    text: '3.3.4 Ознакомительные или демонстрационные (trial) версии ПО',
                    style: subcaptionStyle
                }, {
                    xtype: 'textareafield',
                    height: 150,
                    ...
                    xtype: 'label',
                    text: '3.3.6 Прикладное ПО (дополнительное), отсутствующее в реестре ЛПО УрФУ',
                    style: subcaptionStyle
                }, {
                    xtype: 'textareafield',
                    height: 150,
            ...
            items: {
                ...
                items: [{
                    xtype: 'label',
                    text: '3.4. Базы данных, информационно-справочные и поисковые системы',
                    style: captionStyle
                }, {
            ...
            items: {
                ...
                items: [{
                    xtype: 'label',
                    text: '3.5. Электронные образовательные ресурсы',
                    style: captionStyle
                }, {
